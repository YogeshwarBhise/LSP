...
Problem statement
Copy a file from the given bytes offset from the source file

Input :
Source Filename and destination filename along with the offset

Output
Partial file copied from the starting of offset
